...
export default function TimerCard({ minute, success, reporter, ago, note, conditions, isOwn, onDelete }: Props) {
  return (
    <li className="bg-card border border-card-border rounded-xl px-4 py-3 space-y-1.5">
      ...
      {note && (
        <p className="text-xs text-ink/70 leading-snug pl-10 italic">{note}</p>
      )}
    </li>
  )
}
